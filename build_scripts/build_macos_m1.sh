...
if [ "$NOTARIZE" ]; then
  electron-osx-sign MoGua-darwin-arm64/MoGua.app --platform=darwin \
...
DMG_NAME="MoGua-$GREENDOGE_INSTALLER_VERSION-arm64.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/MoGua-darwin-arm64/MoGua.app MoGua-$GREENDOGE_INSTALLER_VERSION-arm64 \
