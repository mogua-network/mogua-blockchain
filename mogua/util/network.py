...
def class_for_type(type: NodeType) -> Any:
    if type is NodeType.FULL_NODE:
        ...
        from mogua.introducer.introducer_api import IntroducerAPI

        return IntroducerAPI
    elif type is NodeType.TIMELORD:
        from mogua.timelord.timelord_api import TimelordAPI
        ...
        from mogua.harvester.harvester_api import HarvesterAPI
