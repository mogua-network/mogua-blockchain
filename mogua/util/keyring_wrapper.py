...
from mogua.util.default_root import DEFAULT_KEYS_ROOT_PATH
from mogua.util.file_keyring import FileKeyring
from mogua.util.misc import prompt_yes_no
...
DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE = "$ mogua passphrase set # all the cool kids are doing it!"
...
class KeyringWrapper:
    ...
    def set_master_passphrase(
        ...
        from mogua.util.keychain import KeyringCurrentPassphaseIsInvalid, KeyringRequiresMigration
    ...
    def confirm_migration(self) -> bool:
        ...
        if master_passphrase == DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE:
            ...
            print(
                "Would you like to set a master passphrase now? Use 'mogua passphrase set' to change the passphrase.\n"
            )

            response = prompt_yes_no("Set keyring master passphrase? (y/n) ")
            if response:
                from mogua.cmds.passphrase_funcs import prompt_for_new_passphrase
                ...
                print(
                    "Will skip setting a master passphrase. Use 'mogua passphrase set' to set the master passphrase.\n"
                )
        else:
            import colorama
    ...
    def migrate_legacy_keyring(self):
        ...
        from mogua.util.keychain import Keychain, MAX_KEYS
    ...
    def confirm_legacy_keyring_cleanup(self, legacy_keyring, service, users):
        ...
        # [mogua_2Duser_2Dmogua_2D1_2E8] is left behind
