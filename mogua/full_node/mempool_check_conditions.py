...
from mogua.consensus.condition_costs import ConditionCost
from mogua.full_node.generator import create_generator_args, setup_generator_args
from mogua.types.blockchain_format.coin import Coin
from mogua.types.blockchain_format.program import NIL
...
from mogua.util.clvm import int_from_bytes, int_to_bytes
...
from mogua.util.ints import uint32, uint64, uint16
from mogua.wallet.puzzles.generator_loader import GENERATOR_FOR_SINGLE_COIN_MOD
from mogua.wallet.puzzles.rom_bootstrap_generator import get_generator
...
def parse_aggsig(args: SExp) -> List[bytes]:
    ...
    # just like as_atom_list() (see mogua/types/blockchain_format/program.py)
