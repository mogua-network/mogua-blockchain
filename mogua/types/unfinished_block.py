...
from mogua.types.blockchain_format.foliage import Foliage, FoliageTransactionBlock, TransactionsInfo
...
from mogua.types.blockchain_format.vdf import VDFProof
