...
from mogua.wallet.cc_wallet import cc_utils
from mogua.wallet.cc_wallet.cc_utils import CC_MOD, SpendableCC, spend_bundle_for_spendable_ccs, uncurry_cc
from mogua.wallet.cc_wallet.cc_wallet import CCWallet
from mogua.wallet.puzzles.genesis_by_coin_id_with_0 import genesis_coin_id_for_genesis_coin_checker
from mogua.wallet.trade_record import TradeRecord
from mogua.wallet.trading.trade_status import TradeStatus
from mogua.wallet.trading.trade_store import TradeStore
from mogua.wallet.transaction_record import TransactionRecord
from mogua.wallet.util.trade_utils import (
        ...
        if mogua_discrepancy is not None:
            ...
            if mogua_spend_bundle is not None:
                for coinsol in coinsols:
                    mogua_spend_bundle.coin_spends.append(coinsol)
                ...
                if my_cc_spends is None or my_cc_spends == set():
                    ...
                    if zero_spend_bundle is None:
                        return (
                            False,
                            None,
                            "Unable to generate zero value coin. Confirm that you have mogua available",
                        )
