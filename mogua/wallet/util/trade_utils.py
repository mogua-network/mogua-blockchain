...
from mogua.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "mogua" in cc_discrepancies:
                    cc_discrepancies["mogua"] = cc_discrepancies["mogua"] + diff
                else:
                    cc_discrepancies["mogua"] = diff
