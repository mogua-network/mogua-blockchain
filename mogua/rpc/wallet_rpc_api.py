...
from mogua.cmds.init_funcs import check_keys
from mogua.consensus.block_rewards import calculate_base_farmer_reward
from mogua.pools.pool_wallet import PoolWallet
from mogua.pools.pool_wallet_info import create_pool_state, FARMING_TO_POOL, PoolWalletInfo, PoolState
...
from mogua.util.keychain import bytes_to_mnemonic, generate_mnemonic
from mogua.util.path import path_from_root
from mogua.util.ws_message import WsRpcMessage, create_payload_dict
from mogua.wallet.cc_wallet.cc_wallet import CCWallet
from mogua.wallet.derive_keys import master_sk_to_singleton_owner_sk
from mogua.wallet.rl_wallet.rl_wallet import RLWallet
from mogua.wallet.derive_keys import master_sk_to_farmer_sk, master_sk_to_pool_sk, master_sk_to_wallet_sk
from mogua.wallet.did_wallet.did_wallet import DIDWallet
from mogua.wallet.trade_record import TradeRecord
from mogua.wallet.transaction_record import TransactionRecord
from mogua.wallet.util.backup_utils import download_backup, get_backup_info, upload_backup
from mogua.wallet.util.trade_utils import trade_record_to_dict
...
from mogua.wallet.wallet_node import WalletNode
...
class WalletRpcApi:
    ...
    async def _check_key_used_for_rewards(
        ...
        farmer_target = config["farmer"].get("mga_target_address")
        pool_target = config["pool"].get("mga_target_address")
        found_farmer = False
        found_pool = False
    ...
    async def create_new_wallet(self, request: Dict):
        ...
        if request["wallet_type"] == "cc_wallet":
            ...
            if request["mode"] == "new":
                ...
                from mogua.pools.pool_wallet_info import initial_pool_state_from_dict
