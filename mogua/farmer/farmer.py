...
from mogua.pools.pool_config import PoolWalletConfig, load_pool_config
from mogua.protocols import farmer_protocol, harvester_protocol
from mogua.protocols.pool_protocol import (
    ErrorResponse,
...
from mogua.util.config import load_config, save_config, config_path_for_filename
...
from mogua.wallet.puzzles.singleton_top_layer import SINGLETON_MOD
...
class Farmer:
    ...
    async def setup_keys(self):
        ...
        if len(self.get_public_keys()) == 0:
            error_str = "No keys exist. Please run 'mogua keys generate' or open the UI."
        ...
        self.pool_target_encoded = self.pool_config["mga_target_address"]
