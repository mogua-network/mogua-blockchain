...
def calculate_pool_reward(height: uint32) -> uint64:
    ...
    if height == 0:
        ...
        return uint64(int((7 / 8) * 50 * _mojo_per_mogua))  # Reward for early participants in the community.
...
def calculate_base_farmer_reward(height: uint32) -> uint64:
    ...
    if height == 0:
        ...
        return uint64(int((1 / 8) * 50 * _mojo_per_mogua))  # Reward for early participants in the community.
    elif height < 3 * _blocks_per_year:
