...
from mogua.pools.pool_config import PoolWalletConfig, load_pool_config, update_pool_config
from mogua.pools.pool_wallet_info import (
    PoolWalletInfo,
    PoolSingletonState,
    PoolState,
    FARMING_TO_POOL,
...
from mogua.protocols.pool_protocol import POOL_PROTOCOL_VERSION
...
from mogua.pools.pool_puzzles import (
...
from mogua.util.ints import uint8, uint32, uint64
from mogua.wallet.derive_keys import (
    master_sk_to_pooling_authentication_sk,
    find_owner_sk,
)
from mogua.wallet.sign_coin_spends import sign_coin_spends
...
class PoolWallet:
    ...
    async def create_new_pool_wallet_transaction(
        ...
        the same pooling puzzle. This puzzle is a `mogua singleton` that is
