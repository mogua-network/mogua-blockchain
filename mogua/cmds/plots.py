...
def show_plots(root_path: Path):
    from mogua.plotting.util import get_plot_directories
...
def create_cmd(
    ...
    from mogua.plotting.create_plots import create_plots, resolve_plot_keys
...
def remove_cmd(ctx: click.Context, final_dir: str):
    from mogua.plotting.util import remove_plot_directory
