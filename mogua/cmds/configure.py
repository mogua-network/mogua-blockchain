...
from mogua.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "56544"
            testnet_introducer = "beta1_introducer.mogua.gua"
            testnet = "testnet7"
            ...
            mainnet_port = "6544"
            mainnet_introducer = "introducer.mogua.gua"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running mogua services for changes to take effect")
