...
from moguavdf import create_discriminant

from mogua.consensus.constants import ConsensusConstants
from mogua.consensus.pot_iterations import calculate_sp_iters, is_overflow_block
...
from mogua.timelord.iters_from_block import iters_from_block
from mogua.timelord.timelord_state import LastState
from mogua.timelord.types import Chain, IterationType, StateType
from mogua.types.blockchain_format.classgroup import ClassgroupElement
from mogua.types.blockchain_format.reward_chain_block import RewardChainBlock
...
class Timelord:
    def __init__(self, root_path, config: Dict, constants: ConsensusConstants):
        ...
        self.server: Optional[MoguaServer] = None
