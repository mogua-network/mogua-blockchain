...
from mogua.wallet.puzzles.p2_conditions import puzzle_for_conditions
from mogua.wallet.puzzles import singleton_top_layer
from mogua.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - mogua.pools.pool_puzzles.py
    - mogua.wallet.puzzles.pool_member_innerpuz.clvm
    - mogua.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
