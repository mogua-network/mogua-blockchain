...
from mogua.util.keychain import Keychain, bytes_from_mnemonic, bytes_to_mnemonic, generate_mnemonic, mnemonic_to_seed
...
class TesKeychain(unittest.TestCase):
    ...
    def test_bip39_eip2333_test_vector(self):
        ...
        tv_master_int = 5399117110774477986698372024995405256382522670366369834617409488921348441851
