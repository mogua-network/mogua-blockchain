...
from mogua.plotting.plot_tools import stream_plot_info_ph, stream_plot_info_pk
from mogua.protocols import farmer_protocol
from mogua.rpc.farmer_rpc_api import FarmerRpcApi
from mogua.rpc.farmer_rpc_client import FarmerRpcClient
from mogua.rpc.harvester_rpc_api import HarvesterRpcApi
from mogua.rpc.harvester_rpc_client import HarvesterRpcClient
...
from mogua.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_pooling_authentication_sk
...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            assert config["farmer"]["gdog_target_address"] == encode_puzzle_hash(new_ph, "mga")
            assert config["pool"]["gdog_target_address"] == encode_puzzle_hash(new_ph_3, "mga")
