...
If you want to learn more about this project, read the [wiki](https://github.com/MoGua-Network/mogua-blockchain/wiki), or check out the [green paper](https://www.mogua.mog/assets/GreenDogeGreenPaper.pdf).
