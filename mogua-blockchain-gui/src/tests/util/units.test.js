...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of mogua', () => {
      const result = units.getUnit('mogua');

      expect(result).toBe(1);
    });
    it('gets unit of mog', () => {
      const result = units.getUnit('mog');
    ...
    it('gets unit of mog using alias', () => {
  ...
  describe('#getDisplay', () => {
    ...
    it('gets display of mog', () => {
      const result = units.getDisplay('mog');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('mogua', 9);

      const result = units.getUnit('mogua');

      expect(result).toEqual(9);

      units.setUnit('mogua', 1);
    });
  });
  describe('#setDisplay', () => {
