  ...
  const rows = [
    {
      ...
      value: (
        <Link target="_blank" href={`https://alltheblocks.net/mogua/block/${blockRecord.header_hash}`}>
          {blockRecord.header_hash}
        </Link>
      ),
    },
    {
    ...
    },
    {
      ...
      value: (
        <Link target="_blank" href={`https://alltheblocks.net/mogua/address/${currencyCode ? toBech32m(blockRecord.farmer_puzzle_hash, currencyCode.toLowerCase()) : ''}`}>
    ...
    },
    {
      ...
      value: (
        <Link target="_blank" href={`https://alltheblocks.net/mogua/address/${currencyCode ? toBech32m(blockRecord.pool_puzzle_hash, currencyCode.toLowerCase()) : ''}`}>
