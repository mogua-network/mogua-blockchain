...
import { Card, FormatLargeNumber, Link, Loading, TooltipIcon, Flex } from '@mogua/core';
import {
  unix_to_short_date,
  hex_to_array,
  arr_to_hex,
...
export default function Block() {
  ...
  const baseFarmerReward = mojo_to_mogua(calculateBaseFarmerReward(blockRecord.height));
    ...
    >
      <Card
        title={(
          <BlockTitle>
            <Trans>
              Block at height {blockRecord.height} in the MoGua
              blockchain
            </Trans>
          </BlockTitle>
        )}
