...
If you want to learn more about this project, read the [wiki](https://github.com/Mogua-Network/mogua-blockchain/wiki), or check out the [green paper](https://www.mogua.gua/assets/GreenDogePaper.pdf).
