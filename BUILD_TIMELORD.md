...
required to run a [Timelord](https://github.com/MoGua/mogua-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/MoGua/mogua-blockchain/blob/main/install-timelord.sh)
